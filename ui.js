...
KSL.ICON_SUPPORT =
  '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' +
  '<path d="M20.4 8.6c0 4.9-8.4 9.9-8.4 9.9s-8.4-5-8.4-9.9A4.4 4.4 0 0 1 8 4.2c1.7 0 2.9.8 4 2.1 1.1-1.3 2.3-2.1 4-2.1a4.4 4.4 0 0 1 4.4 4.4Z"/></svg>';
...
KSL.buildPanelHtml = function (merchantId) {
  ...
  return (
    ...
    '<div class="ksl-content hidden" id="supportTab">' +
    KSL.Ads.getBannerHtml() +
    ...
    '<button class="nav-btn" data-tab="support" data-i18n-aria="navSupport">' + KSL.ICON_SUPPORT + '</button>' +
    '</div>' +
...
KSL.bindTabs = function (shadow, onTab) {
  const tabs = {
    ...
    support: shadow.getElementById('supportTab')
  };
